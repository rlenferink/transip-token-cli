 ...
 *
 * Customizations applied by Roy Lenferink <lenferinkroy@gmail.com>
 *  - Replaced const with private for instance variables
 *  - Added constructor to allow object initialization
 *
...
class TransIP_AccessToken
{
     ...
     */
    private $GLOBAL_KEY = false;

    /**
     * Default expiration time.
     * The maximum expiration time is one month.
     */
    private $EXPIRATION_TIME = '30 minutes';
    ...
    /**
     * Create a AccessToken instance
     *
     * Added as extension by Roy Lenferink <lenferinkroy@gmail.com>
     */
    public function __construct($login, $key, $read_only, $global, $expiration_time)
    {
        $this->LOGIN = $login;
        $this->PRIVATE_KEY = $key;
        $this->READ_ONLY = $read_only;
        $this->GLOBAL_KEY = $global;
